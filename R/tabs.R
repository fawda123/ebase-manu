...
ebaseiotab <- flextable(totab) %>% 
  ...
  flextable::compose(i = 2, j = 4, value = as_paragraph(as_equation('\\text{mg}/\\text{L}', props = eqsz))) %>% 
  ...
  flextable::compose(i = 6, j = 4, value = as_paragraph(as_equation('\\text{m}/\\text{s}', props = eqsz))) %>% 
  ...
  flextable::compose(i = 14, j = 4, value = as_paragraph(as_equation('\\text{mmol}/\\text{m}^3/\\text{d}', props = eqsz))) %>% 
  flextable::compose(i = 15, j = 4, value = as_paragraph(as_equation('\\text{mmol}/\\text{m}^3/\\text{d}', props = eqsz))) %>% 
  flextable::compose(i = 16, j = 4, value = as_paragraph(as_equation('\\text{mmol}/\\text{m}^3/\\text{d}', props = eqsz))) %>% 
  flextable::compose(i = 17, j = 4, value = as_paragraph(as_equation('\\left(\\text{mmol}/\\text{m}^2/\\text{d}\\right)/\\left(\\text{Watts}/\\text{m}^2\\right)', props = eqsz))) %>% 
  flextable::compose(i = 18, j = 4, value = as_paragraph(as_equation('\\left(\\text{cm}/\\text{hr}\\right)/\\left(\\text{m}^2/\\text{s}^2\\right)', props = eqsz))) %>%
