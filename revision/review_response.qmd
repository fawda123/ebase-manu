...
*Response: Yes, C represents observed dissolved oxygen concentration (as noted on line 132).  We have retained C instead of using Cobs for simplicity in the model equations.  Further, the addition of the model input/output table as requested by another review helps clarify data.*
